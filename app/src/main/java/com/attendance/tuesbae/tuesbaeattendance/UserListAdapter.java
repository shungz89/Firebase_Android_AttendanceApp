...
public class UserListAdapter extends BaseAdapter {
    ...
    //We need to create a List to STORE every users we created
    private List<User> UserList = new ArrayList<>();

    //To create this adapter we need 2 input, one is which activity to bind it, two is the UserList that contains list of users
...
//        }
            ...
            TextView ID_TextView = (TextView) view.findViewById(R.id.userlist_id_textview);
            TextView Name_TextView = (TextView) view.findViewById(R.id.userlist_name_textview);
            TextView Status_TextView = (TextView) view.findViewById(R.id.userlist_status_textview);

            LinearLayout List_Layout = view.findViewById(R.id.userlist_background);


            ID_TextView.setText(String.valueOf(i+1));
            Name_TextView.setText(UserList.get(i).getName());
        Status_TextView.setText(UserList.get(i).getStatus());

        if(Status_TextView.getText().toString().equals("Paid")){
            List_Layout.setBackgroundColor(view.getResources().getColor(R.color.theme_accent));
        }
        else{
            List_Layout.setBackgroundColor(view.getResources().getColor(R.color.theme_primary_dark));
        }
